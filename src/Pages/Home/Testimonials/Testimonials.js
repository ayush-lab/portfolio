    ...
    return (
        <>
            <div className={styles.main}>
                ...
                <h2 className={styles.Heading} data-aos="fade-up" data-aos-anchor-placement="top-center" data-aos-duration="1500" > Testimonials </h2>
                <h4 className={styles.subHeading} data-aos="fade-up" data-aos-anchor-placement="top-center" data-aos-duration="1500" > People that I have worked with have said </h4>
